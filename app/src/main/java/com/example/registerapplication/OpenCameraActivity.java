...
public class OpenCameraActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_camera.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                /* Toast.makeText(OpenCameraActivity.this, "Camera Button is Clicked",Toast.LENGTH_SHORT).show();*/
                askCameraPermissions();
            }
        });

        Camera_image_view = (ImageView) findViewById(R.id.Camera_imageView);
    }

    private void askCameraPermissions() {
        // checked the permision
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == CAMERA_REQUEST_CODE)
        {
            ...
            Camera_image_view.setImageBitmap(image);
